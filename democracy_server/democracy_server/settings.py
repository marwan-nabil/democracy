...
SECRET_KEY = '+yye2aowhzkniuv_xce0q@$ayd#mxq@r7ht#9jy!dq6azo_d#3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# (marwan): to allow all hosts on local network to access our server
ALLOWED_HOSTS = ['*']

# (marwan): i override the default user model with my own
...
WSGI_APPLICATION = 'democracy_server.wsgi.application'
...
# static files (our css/html/js) and user-uploaded media
STATIC_URL = '/static/'
MEDIA_URL = '/media/'
